...
for level1, level2 in combos:
    print(level1, level2)
    coef = np.load(f'../results_pearson/pearson_array_{level1}_{level2}.npy')
    pval = np.load(f'../results_pearson/pval_array_{level1}_{level2}.npy')
    ...
    adj1 = load_pickle(f'../results_pearson/{level1}_adj_df_weighted_pearson.pickle') #las networks calculadas antes
    adj2 = load_pickle(f'../results_pearson/{level2}_adj_df_weighted_pearson.pickle')
    ...
    for i, name in enumerate(["unweighted", "weighted"]):
        ...
        adj_file = f'../results_pearson/{level1}_{level2}_adj_df_{name}_pearson.pickle'
        net_file = f'../results_pearson/{level1}_{level2}_network_{name}_pearson.json'
